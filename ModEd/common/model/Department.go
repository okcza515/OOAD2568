...
type Department struct {
	gorm.Model
	DepartmentId 	uuid.UUID   	`gorm:"type:text;primaryKey;not null;unique" csv:"department_id" json:"department_id"`
	...
	CourseId    	*[]uuid.UUID 	`gorm:"type:text[]" csv:"course_id" json:"course_id"` // UUID to avoid circular dependency
