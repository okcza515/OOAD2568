...
func main() {
	...
	for {
		...
		fmt.Println("=========================")
		fmt.Println("1. Add New Assignment")
		fmt.Println("2. Delete Assignment")
		fmt.Println("3. Update Assignment")
		fmt.Println("4. Display All Assignments")
		fmt.Println("5. Query Assignment by ID")
		fmt.Println("6. Query Assignments by Status")
		fmt.Println("7. Query Assignments by Date Range")
		fmt.Println("8. Exit")
		...
		switch choice {
		case 1:
			addAssignment(assignmentController)
		case 2:
			deleteAssignment(assignmentController)
		case 3:
			updateAssignment(assignmentController)
		case 4:
			displayAllAssignments(assignmentController)
		case 5:
			queryAssignmentByID(assignmentController)
		case 6:
			queryAssignmentsByStatus(assignmentController)
		case 7:
			queryAssignmentsByDateRange(assignmentController)
		case 8:
			fmt.Println("Goodbye!")
			return
		default:
