...
type Question struct {
	...
	ShortAnswer           ShortAnswer            `gorm:"foreignKey:QuestionID;references:ID" json:"-" csv:"-"`
	TruefalseAnswer       TrueFalseAnswer        `gorm:"foreignKey:QuestionID;references:ID" json:"-" csv:"-"`
	MultipleChoiceAnswers []MultipleChoiceAnswer `gorm:"foreignKey:QuestionID;references:ID" json:"-" csv:"-"`
}
