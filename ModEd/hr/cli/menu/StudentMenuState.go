...
func NewStudentMenuState(
	...
	reviewLeaveHandler := hrHandler.NewReviewHandlerStrategy(leaveStudentCtrl.ReviewLeaveRequest)
	reviewResignationHandler := hrHandler.NewReviewHandlerStrategy(resignStudentCtrl.ReviewResignationRequest)
