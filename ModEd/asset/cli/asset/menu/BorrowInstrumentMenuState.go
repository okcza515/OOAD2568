...
func (menu *BorrowInstrumentMenuState) Render() {
	...
	fmt.Println()
	fmt.Println("  1:\tAdd New BorrowInstrument")
	fmt.Println("  2:\tList all BorrowInstrument")
	fmt.Println("  3:\tGet full detail of an BorrowInstrument")
	fmt.Println("  4:\tUpdate an BorrowInstrument")
	fmt.Println("  5:\tDelete an BorrowInstrument")
