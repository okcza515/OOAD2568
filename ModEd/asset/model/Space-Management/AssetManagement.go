...
type AssetManagement struct {
    ...
    Instrument          Instrument        `gorm:"foreignKey:InstrumentID;references:InstrumentID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"instrument"`
    ...
    Supply              Supply            `gorm:"foreignKey:SupplyID;references:SupplyID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"supply"`
    ...
    BorrowInstrument    BorrowInstrument  `gorm:"foreignKey:BorrowID;references:BorrowID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"borrow_instrument"`
