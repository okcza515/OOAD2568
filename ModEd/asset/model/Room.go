...
type Room struct {
	RoomID             uuid.UUID         `gorm:"type:text;primaryKey" json:"classroom_id" csv:"classroom_id"`
	RoomName           string            `gorm:"type:varchar(255);not null" json:"classroom_name" csv:"classroom_name"`
