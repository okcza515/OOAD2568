...
type InstrumentManagement struct {
	...
	BorrowInstrument   	asset.BorrowInstrument `gorm:"foreignKey:BorrowUserID;references:BorrowUserID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"borrow_instrument"`
	...
	Instrument         	asset.Instrument       `gorm:"foreignKey:InstrumentSerialID;references:InstrumentSerialID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"instrument"`
