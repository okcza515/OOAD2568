...
type AssetManagement struct {
    ...
    Instrument          model.Instrument        `gorm:"foreignKey:InstrumentID;references:InstrumentID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"instrument"`
    ...
    Supply              model.Supply            `gorm:"foreignKey:SupplyID;references:SupplyID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"supply"`
    ...
    BorrowInstrument    model.BorrowInstrument  `gorm:"foreignKey:BorrowID;references:BorrowID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"borrow_instrument"`
