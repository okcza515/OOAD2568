...
type PermanentSchedule struct {
	...
	Faculty     master.Faculty     `gorm:"foreignKey:Faculty;references:Name" json:"faculty" csv:"faculty"`
	Department  master.Department  `gorm:"foreignKey:Department;references:Name" json:"department" csv:"department"`
