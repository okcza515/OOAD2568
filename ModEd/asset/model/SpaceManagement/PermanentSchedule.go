...
type PermanentSchedule struct {
	...
	Faculty     master.Faculty     `gorm:"foreignKey:Name;references:Name" json:"faculty" csv:"faculty"`
	Department  master.Department  `gorm:"foreignKey:Name;references:Name" json:"department" csv:"department"`
