...
## Design Patterns
1. Command Design Pattern (cli.go)
2. Facade Design Pattern (cli.go - `RegisterCommand()`)
3. Chain of responsibility Design Pattern (cli-handler)
4. Factory Design Pattern (all controllers)
