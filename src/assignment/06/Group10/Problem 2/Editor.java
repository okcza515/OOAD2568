...
public class Editor implements Mediator {
    ...
    private static JLabel label = new JLabel("Add or select existing note to proceed...");
        ...
        public void createElement(Element element) {
            ...
            if (elementName.equals("Add Button")) {
                add = (AddButton) element;
            } else if (elementName.equals("Delete Button")) {
                del = (DeleteButton) element;
            ...
            } else if (elementName.equals("Save Button")) {
                save = (SaveButton) element;
            } else if (elementName.equals("Text Box")) {
